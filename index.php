...
<body id="page-top" style="">
  ...
  <footer class=" py-5">
    ...
    <br>
    <div class="container">
      <div class="small text-center text-muted">Copyright © 2020 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.sourcecodester.com/" target="_blank">UIN ALAUDDIN MAKASSAR</a></div>
    </div>
  </footer>
