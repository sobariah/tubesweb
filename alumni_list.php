	...
	margin:unset;
        ...
        <header class="masthead">
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end mb-4 page-title">
                        <h3 class="text-white">Data Alumni</h3>
            ...
            <div class="container-fluid mt-3 pt-2">
                ...
                $alumni = $conn->query("SELECT a.*,c.course,Concat(a.firstname,', ',a.lastname,' ',a.middlename, ' ',a.nim) as name from alumnus_bio a inner join courses c on c.id = a.course_id order by Concat(a.firstname,', ',a.lastname,' ',a.middlename, ' ',a.nim) asc");
                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                ...
                                <p class="filter-txt">Tempat Bekerja <b><?php echo $row['connected_to'] ?></b></p>
                                    <br>
                                </div>
                            </div>
                        </div>
