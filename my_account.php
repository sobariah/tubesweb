                                    ...
                                    <form action="" id="update_account">
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="namadepan" value="<?php echo $_SESSION['bio']['namadepan'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                                ...
                                                <select class="custom-select" name="gender" required>
                                                    <option <?php echo $_SESSION['bio']['gender'] =='Male' ? 'selected' : '' ?>>Laki Laki</option>
                                                    <option <?php echo $_SESSION['bio']['gender'] =='Female' ? 'selected' : '' ?>>Perempuan</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Universitas</label>
